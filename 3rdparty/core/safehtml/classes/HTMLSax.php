...
class XML_HTMLSax_StateParser {
    ...
    */
    function XML_HTMLSax_StateParser (& $htmlsax) {
        ...
        $this->State[XML_HTMLSAX_STATE_CLOSING_TAG] = instantiate('XML_HTMLSax_ClosingTagState');
        $this->State[XML_HTMLSAX_STATE_TAG] = instantiate('XML_HTMLSax_TagState');
        $this->State[XML_HTMLSAX_STATE_OPENING_TAG] = instantiate('XML_HTMLSax_OpeningTagState');

        $this->State[XML_HTMLSAX_STATE_PI] = instantiate('XML_HTMLSax_PiState');
        $this->State[XML_HTMLSAX_STATE_JASP] = instantiate('XML_HTMLSax_JaspState');
        $this->State[XML_HTMLSAX_STATE_ESCAPE] = instantiate('XML_HTMLSax_EscapeState');
    }
    ...
    */
    function parse($data) {
        if ($this->parser_options['XML_OPTION_TRIM_DATA_NODES']==1) {
            $decorator = instantiate('XML_HTMLSax_Trim',
        ...
        if ($this->parser_options['XML_OPTION_CASE_FOLDING']==1) {
            $open_decor = instantiate('XML_HTMLSax_CaseFolding',
        ...
        if ($this->parser_options['XML_OPTION_LINEFEED_BREAK']==1) {
            $decorator = instantiate('XML_HTMLSax_Linefeed',
                $this->handler_object_data,
                $this->handler_method_data);
            $this->handler_object_data =& $decorator;
        ...
        if ($this->parser_options['XML_OPTION_TAB_BREAK']==1) {
            $decorator = instantiate('XML_HTMLSax_Tab',
                $this->handler_object_data,
                $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
        ...
        if ($this->parser_options['XML_OPTION_ENTITIES_UNPARSED']==1) {
            $decorator = instantiate('XML_HTMLSax_Entities_Unparsed',
                $this->handler_object_data,
                $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
        ...
        if ($this->parser_options['XML_OPTION_ENTITIES_PARSED']==1) {
            $decorator = instantiate('XML_HTMLSax_Entities_Parsed',
                $this->handler_object_data,
                $this->handler_method_data);
            $this->handler_object_data =& $decorator;
            $this->handler_method_data = 'breakData';
