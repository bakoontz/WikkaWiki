...
//defaults
define('INFOBOX_LATEST_VERSION', '1.1.6.7');
define('INFOBOX_DEFAULT_ALIGN', 'float: right');
define('INFOBOX_DEFAULT_MARGIN', 'margin: 0 0 10px 10px');
$valid_versions = array('1.1.6.0', '1.1.6.1', '1.1.6.2', '1.1.6.3', '1.1.6.4', '1.1.6.5', '1.1.6.6', '1.1.6.7', '1.1.7', '1.2', '1.3', '1.3.1', '1.3.2', '1.3.3', '1.4', '1.5', '1.6', '1.7', '1.8', '1.9', '2.0', '3.0');
...
{
	$display_version = INFOBOX_LATEST_VERSION;
}
...
{
	//display inline tag 
	echo '<div title="This feature was introduced in WikkaWiki '.$display_version.' and is not supported in earlier versions" style="cursor: help; margin: 2px; display: inline; padding: 2px 3px; font-size: 85%; line-height: 150%; background-color: '.$c[$s][1].'; border: 1px solid '.$c[$s][4].';">'."\n";
	echo '<strong>since '.$display_version.'</strong>'."\n";
	echo '</div>'."\n";
}
else
{	
	//display full infobox
	echo '<div title="This feature was introduced in WikkaWiki '.$display_version.' and is not supported in earlier versions" style="cursor: help; '.$float.'; width: 200px; border: 1px solid '.$c[$s][0].'; background-color: '.$c[$s][1].'; color: '.$c[$s][2].'; '.$margin.'">'."\n";
	...
	echo 'This feature is available since:<br /> <strong>WikkaWiki '.$display_version.'</strong>'."\n";
	echo '</div>'."\n";
	echo '</div>'."\n";
}
?>
