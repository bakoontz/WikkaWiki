...
<table border="0" cellspacing="0" cellpadding="0">
        <tr>
                <td>Search for:&nbsp;</td>
                <td><input name="phrase" size="40" value="<?php if (isset($_REQUEST["phrase"])) echo htmlspecialchars($_REQUEST["phrase"]); ?>" /> <input type="submit" value="Search"/></td>
        </tr>
</table>
...
if (isset($_REQUEST["phrase"]) && $phrase = $_REQUEST["phrase"])
{
        ...
        if ($results = $this->FullTextSearchAndLikeTags($phrase))
        {
                ...
                foreach ($results as $i => $page)
                {
                        ...
                        $text = htmlspecialchars($matchString[0]);
