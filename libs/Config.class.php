...
//	var $base_url;			//  dynamically derived now
	 ...
	 * 
	 * This value is a suffix for a cookie name, so you should specify characters
	 * that are legal to be a cookie name. {@see http://tracker.wikkawiki.org/ticket/761}
	 */
	var $wiki_suffix = '_wikka';
	...
	/**
	 * Theme.
	 * Name of theme used by your Wikka site. This entry must not be
	 * empty and must point to an existing theme directory. The
