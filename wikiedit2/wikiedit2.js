...
// if (!this.area.id) this.area.id = "area_"+String(Math.floor(Math.random()*10000));
 ...
 try {
  ...
  var base_till = mylocation.indexOf("wakka.php");
  if(base_till==-1) {
 ...
 if (isIE)
 {
  this.area.addBehavior(base_url+"wikiedit2/sel.htc");
 }

 this.imagesPath = (imgPath?imgPath:base_url+"wikiedit2/images/");
...
{
 s =  " WikiEdit 2.07 (Specially for Wikka)\n";
