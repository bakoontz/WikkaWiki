...
if ($this->GetUser()) {
	if ($referrers)
	{
		...
		foreach ($referrers as $referrer)
		{
			...
			print("<td valign=\"top\"><a href=\"".htmlspecialchars($referrer["referrer"])."\">".htmlspecialchars($referrer["referrer"])."</a> ".($IsAdmin ? "[<a href=\"".$this->href("delete_referrer", "", "spam_link=").htmlspecialchars($referrer["referrer"])."&redirect=".$this->GetMethod()."\">Blacklist</a>]" : "")."</td>");
			print("</tr>\n");
		}
		print("</table>\n");
	}
