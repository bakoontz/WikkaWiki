...
if ($this->UserIsOwner())
{
	if ($_POST)
	{
		// store lists only if different than defaults
		...
		if ($posted_read_acl != $default_read_acl || $posted_write_acl != $default_write_acl || $posted_comment_acl != $default_comment_acl )
		{
