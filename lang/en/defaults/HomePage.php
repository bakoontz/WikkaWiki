...
printf('~-[[FormattingRules %s]]---', T_("Wikka formatting guide"));
printf('~-[[WikkaDocumentation %s]]---', T_("Documentation"));
printf('~-[[RecentChanges %s]]---', T_("Recently modified pages"));
printf('~-[[SysInfo System %s]]---', T_("Information"));
