 ...
 * @todo		document all replacement vars
 * @todo		use single quotes whenever possible
 * 				(unless	that leads to more than one escaped single quote)
 * @todo		move the rest of the hardcoded texts in here
 * @todo		move OUT the defines that are not language strings
 */
...
define('PAGES_BELONGING_TO', 'The following %d page(s) belong to %s');	# @@@ number vars
...
define('NOT_LOGGED_IN', "You're not logged in, thus the list of pages you've edited couldn't be retrieved.");

// mypages
define('OWNED_PAGES_TXT', 'This is the list of pages you own.'); 
define('NO_OWNED_PAGES', 'You don\'t own any pages.');
define('USER_NOT_LOGGED_IN', "You're not logged in, thus the list of your pages couldn't be retrieved.");
...
define('SEARCH_TRY_EXPANDED', 'Try the %s which shows surrounding text.'); // %s search link # @@@
/*
