...
else
{
	...
	printf(__('Once you\'ve done this, your Wikka site should work. If not, please visit %s'), '<a href="http://wikkawiki.org/WikkaInstallation">Wikka:WikkaInstallation</a>');
	echo '.</p>'."\n";
	?>
