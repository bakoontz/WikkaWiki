...
case "0":
  ...
  test("Adding admin user...", 
    @mysql_query("insert into ".$config["table_prefix"]."users set name = 'WikkaInstaller', password = md5('".mysql_real_escape_string($_POST["password"])."'), email = '".$config["admin_email"]."', signuptime = now()", $dblink), "Hmm!", 0);
