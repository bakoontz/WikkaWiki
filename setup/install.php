...
case "1.1.5.2":
case "1.1.5.3":
	mysql_query("update ".$config["table_prefix"]."pages set latest = 'N' where tag in ('WikkaReleaseNotes', 'WikkaDocumentation')");
...
case "1.1.6.2":
	...
	mysql_query("update ".$config["table_prefix"]."pages set latest = 'N' where tag in ('FormattingRules', 'HighScores')"), "Already done? OK!", 0);
